...
e = Day.create(date:DateTime.now.tomorrow)
c = Category.create(name:"Interview", color:"#ABB8C3")
s = Category.create(name:"Study", color:"#ABB8C3")
sk = Category.create(name:"School", color:"#ABB8C3")
...
e1 = Event.create(title:"Test Event 1", description:"Test test testing event 1", user:me, start: d.id, end: e.id, priority:"High")
e2 = Event.create(title:"Test Event 2", checked: true,description:"Test test testing event 2", user:me,  start: d.id, end: e.id, priority:"Low")
