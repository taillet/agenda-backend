...
td2 = ToDoItem.create(title:"Test To Do 2", description:"Test test testing to do be doo be doooo 2", user:me, day:d,  start: DateTime.new(2019,4,3,17,5,6), end: DateTime.new(2019,2,4,19,5,6), priority:"low")
